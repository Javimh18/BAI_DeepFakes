...
TRAIN_CS = "train_cs.csv"
VALIDATION_CS = "validation_cs.csv"
TRIPLET_CS = "anchors.csv"

TRAIN_SIAMESE_FILE = "siamese_train.csv"
TRAIN_SIAMESE_ALL_FILE =  "siamese_train_all.csv"
